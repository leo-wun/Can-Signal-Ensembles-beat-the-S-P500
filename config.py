...
MONTHLY_CRSP_PATH = DATA_RAW / "monthly_crsp.csv"
COMPUSTAT_PATH = DATA_RAW / "Compustat_quarterly.csv"
FUTURES_PATH = DATA_RAW / "daily_futures.csv"
JKP_PATH = DATA_RAW / "[usa]_[all_factors]_[monthly]_[vw_cap].csv"
CZ_PATH = DATA_RAW / "Chen_Zimmerman_monthly.csv"
CRSP_PATH_RAW = DATA_RAW / "daily_crsp_raw.parquet"
CRSP_LIQUIDITY_RAW = DATA_RAW / "crsp_liquidity_raw.parquet"
CCM_LINKTABLE_PATH = DATA_RAW / "ccm_linktable.parquet"
...
MONTHLY_PANEL_PATH = DATA_PROCESSED / "monthly_panel.parquet"
MONTHLY_DATASET_PATH = DATA_PROCESSED / "monthly_dataset.parquet"
MONTHLY_PREDICTIONS_PATH = DATA_PROCESSED / "monthly_predictions.parquet"
